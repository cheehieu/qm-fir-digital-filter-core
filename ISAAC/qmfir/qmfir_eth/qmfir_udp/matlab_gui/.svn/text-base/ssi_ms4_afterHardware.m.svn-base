function ssi_ms4_afterHardware(skip) 
...
%  2008/10/12. Version 4: simulate target positions by shifting simulated
%  return echo. 
...
% if ichan == 1
%         xbsr_pp3 = load('real1.txt')';
%         xbsr_pp3 = xbsr_pp3(14:length(xbsr_pp3));
%         xbsi_pp3 = load('imag1.txt')';
%         xbsi_pp3 = xbsi_pp3(14:length(xbsi_pp3));
%     elseif ichan == 2
%         xbsr_pp3 = load('real2.txt')';
%         xbsr_pp3 = xbsr_pp3(14:length(xbsr_pp3));
%         xbsi_pp3 = load('imag2.txt')';
%         xbsi_pp3 = xbsi_pp3(14:length(xbsi_pp3));
%     else
%         xbsr_pp3 = load('real3.txt')';
%         xbsr_pp3 = xbsr_pp3(14:length(xbsr_pp3));
%         xbsi_pp3 = load('imag3.txt')';
%         xbsi_pp3 = xbsi_pp3(14:length(xbsi_pp3));
%     end
   if ichan == 1
        xbsr_pp3 = load('real1.txt')';
        xbsr_pp3 = xbsr_pp3(26:length(xbsr_pp3));
        xbsi_pp3 = load('imag1.txt')';
        xbsi_pp3 = -xbsi_pp3(26:length(xbsi_pp3));
    elseif ichan == 2
        xbsr_pp3 = load('real2.txt')';
        xbsr_pp3 = xbsr_pp3(26:length(xbsr_pp3));
        xbsi_pp3 = load('imag2.txt')';
    ...
    if length(xbsr_pp3) < 346
        xbsr_pp3(length(xbsr_pp3)+1:346) = 0;
        xbsi_pp3(length(xbsi_pp3)+1:346) = 0;
    end
