function [xpulse,xiqm1, xiqm2, xiqm3] = ssi_ms4(skip)
...
wp= 0.052359877559830;			% alias-free passband
...
% fid = fopen('/home/kaylangu/Desktop/matlab_gui/InputFiles/signal_3100.txt','wt');             % offset video signal
% fprintf(fid,'%15.8e\n',xov);
% fclose(fid);
% fid = fopen('/home/kaylangu/Desktop/matlab_gui/InputFiles/xiqm1r_3100.txt','wt');             % offset video signal
% fprintf(fid,'%15.8e\n',xiqm1r);
% fclose(fid);
% fid = fopen('/home/kaylangu/Desktop/matlab_gui/InputFiles/xiqm2r_3100.txt','wt');             % offset video signal
% fprintf(fid,'%15.8e\n',xiqm2r);
% fclose(fid);
% fid = fopen('/home/kaylangu/Desktop/matlab_gui/InputFiles/xiqm3r_3100.txt','wt');             % offset video signal
% fprintf(fid,'%15.8e\n',xiqm3r);
% fclose(fid);
% fid = fopen('/home/kaylangu/Desktop/matlab_gui/InputFiles/xiqm1i_3100.txt','wt');             % offset video signal
% fprintf(fid,'%15.8e\n',xiqm1i);
% fclose(fid);
% fid = fopen('/home/kaylangu/Desktop/matlab_gui/InputFiles/xiqm2i_3100.txt','wt');             % offset video signal
% fprintf(fid,'%15.8e\n',xiqm2i);
% fclose(fid);
% fid = fopen('/home/kaylangu/Desktop/matlab_gui/InputFiles/xiqm3i_3100.txt','wt');             % offset video signal
% fprintf(fid,'%15.8e\n',xiqm3i);
% fclose(fid);
