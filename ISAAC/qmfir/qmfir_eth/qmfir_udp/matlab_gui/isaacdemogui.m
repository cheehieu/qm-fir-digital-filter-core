...
heditHost = uicontrol('Style','edit','String','192.168.1.104',...
...
heditRemote = uicontrol('Style','edit','String','192.168.1.15',...
...
gennew = 0;
freqNplot = 0;
host = '192.168.1.104';     %'192.168.0.1';
port = 61557;
remote = '192.168.1.15';    %'192.168.0.15';
remoteport = 61557;
compare = 0;
