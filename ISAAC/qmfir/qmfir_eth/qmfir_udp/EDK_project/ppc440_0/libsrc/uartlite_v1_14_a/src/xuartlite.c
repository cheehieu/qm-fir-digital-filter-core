/* $Id: xuartlite.c,v 1.3 2008/09/26 12:30:41 sadanan Exp $ */
/*****************************************************************************
*
				...
				u32 EffectiveAddr)
{
	 ...
	 */
	XUartLite_mWriteReg(InstancePtr->RegBaseAddress,
...
void XUartLite_ResetFifos(XUartLite *InstancePtr)
{
	 ...
	 */
	Register = XUartLite_mReadReg(InstancePtr->RegBaseAddress,
	 ...
	 */
	XUartLite_mWriteReg(InstancePtr->RegBaseAddress, XUL_CONTROL_REG_OFFSET,
...
int XUartLite_IsSending(XUartLite *InstancePtr)
{
	 ...
	 */
	StatusRegister = XUartLite_mReadReg(InstancePtr->RegBaseAddress,
						XUL_STATUS_REG_OFFSET);
	...
	while (ReceivedCount < InstancePtr->ReceiveBuffer.RemainingBytes) {
		...
		if (StatusRegister & XUL_SR_RX_FIFO_VALID_DATA) {
			InstancePtr->ReceiveBuffer.NextBytePtr[ReceivedCount++]=
				XUartLite_mReadReg(InstancePtr->RegBaseAddress,
							XUL_RX_FIFO_OFFSET);
