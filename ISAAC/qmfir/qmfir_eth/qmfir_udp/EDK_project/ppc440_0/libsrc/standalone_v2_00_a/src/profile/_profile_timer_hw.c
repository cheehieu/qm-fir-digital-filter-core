...
//
// $Header: /devl/xcs/repo/env/Jobs/MDT/sw/bsp/standalone/v2_00_a/src/profile/Attic/_profile_timer_hw.c,v 1.1.2.3 2008/04/29 18:54:21 boq Exp $
// $Id: _profile_timer_hw.c,v 1.1.2.3 2008/04/29 18:54:21 boq Exp $
//
// _program_timer_hw.c:
